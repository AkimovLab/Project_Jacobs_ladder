...
model_types = ["k_aligned", "h_shift", "energy_gaps"]
params_sets = [models_dictionaries.params_k_aligned, models_dictionaries.params_h_shift, models_dictionaries.params_energy_gaps]
...
energy_gaps_labels = models_dictionaries.couplings_list
    ...
    for model_type in model_types:
        for starting_state in initial_states:
            for coord in coords:
                ...
                savename = f"../figures/comparison/{model_type}/{type}_{starting_state}_coord_{coord}_traj_1200.png"
                savename_mixed = f"../figures/comparison/{model_type}/{type}_{starting_state}_mixed_coord_{coord}_traj_1200.png"
                # "mixed" refers to different initial state for adiabatic trajectories and tsh
                filename = f"../data/{model_type}_{starting_state}_coord_{coord}_ntraj_1200.hdf5"
                filename_mixed = f"../data/{model_type}_mixed_{starting_state}_coord_{coord}_ntraj_1200.hdf5"
    ...
    for model_type in model_types:
        for starting_state in initial_states:
            for coord in coords:
                ...
                filename = f"../data/{model_type}_mixed_{starting_state}_coord_{coord}_ntraj_1200.hdf5"
                filelist.append(filename)
