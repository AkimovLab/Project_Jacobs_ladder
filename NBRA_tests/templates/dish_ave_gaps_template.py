...
common_params.update({"rep_tdse":1, "rep_ham":0, "rep_sh":1, "rep_lz":0,
            ...
            "tsh_method":3, "decoherence_algo":-1, "decoherence_times_type":1})
            ...
            for coord in initial_coords:
                for traj in trajs:
                    for number in numbers:
                        ...
                        name = f'dish_ave_gaps_{model_type}_{istate}_coord_{coord}_set_{i}_ntraj_{traj}_number_{number}'
                        name_mixed = f'dish_ave_gaps_{model_type}_mixed_{istate}_coord_{coord}_set_{i}_ntraj_{traj}_number_{number}'
                        ...
                        if mixed:
                            ...
                            params_fssh.update({"rep_ham":0, "force_method":1,  "nac_update_method":1,
                                        "hop_acceptance_algo":20, "x0":[coord], "ave_gaps": AG,
