...
common_params.update({"rep_tdse":1, "rep_ham":0, "rep_sh":1, "rep_lz":0,
            ...
            "tsh_method":3, "decoherence_algo":-1, "decoherence_rates":DR,
            ...
            for coord in initial_coords:
                for traj in trajs:
                    for number in numbers:
                        ...
                        name = f'dish_DR_10_{model_type}_{istate}_coord_{coord}_set_{i}_ntraj_{traj}_number_{number}'
                        name_adi = f'{model_type}_{istate}_coord_{coord}_set_{i}_ntraj_300_number_{number}'
                        name_mixed = f'dish_DR_10_{model_type}_mixed_{istate}_coord_{coord}_set_{i}_ntraj_{traj}_number_{number}'
