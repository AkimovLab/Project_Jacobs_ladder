...
tuple_sets = [ [(300, 1), (300, 2), (300, 3), (300, 4)] ]
                ...
                for set in sets:
                    for tuple_set in tuple_sets:
                        ...
                        for tuple in tuple_set:
                            filelist.append(f"../../out/stored/{dyn_type}_{model_type}_{istate}_coord_{coord}_set_{set}_ntraj_{tuple[0]}_number_{tuple[1]}/mem_data.hdf")
                            new_traj += tuple[0]
                        location = f"../../out/stored/{dyn_type}_{model_type}_{istate}_coord_{coord}_set_{set}_ntraj_{new_traj}_number_1"
