            ...
            for coord in initial_coords:
                for traj in trajs:
                    for number in numbers:
                        ...
                        name = f'dish_DR_25_{model_type}_{istate}_coord_{coord}_set_{i}_ntraj_{traj}_number_{number}'
                        ...
                        model_params_nbra.update( {"filename":f"../../out/adiabatic_md_{name}/mem_data.hdf",
                                               "model":2 } )
