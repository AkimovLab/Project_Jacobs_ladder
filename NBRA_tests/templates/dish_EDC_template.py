            ...
            for coord in initial_coords:
                for traj in trajs:
                    for number in numbers:
                        ...
                        name = f'dish_EDC_{model_type}_{istate}_coord_{coord}_set_{i}_ntraj_{traj}_number_{number}'
                        name_adi = f'{model_type}_{istate}_coord_{coord}_set_{i}_ntraj_300_number_{number}'
                        name_mixed = f'dish_EDC_{model_type}_mixed_{istate}_coord_{coord}_set_{i}_ntraj_{traj}_number_{number}'
                        ...
                        if mixed:
                            ...
                            params_fssh.update({"rep_ham":0, "force_method":1,  "nac_update_method":1,
                                        "hop_acceptance_algo":20, "x0":[coord],
