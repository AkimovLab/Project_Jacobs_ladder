...
def main_tully_mdls(model_indx, p0, recipe_indx, recipes_pool ):
    ...
    dyn_params = { "nsteps":2000, "dt":(1.0/p0)*units.fs2au, 
                   "ntraj":100, "x0":[-10.0], "p0":[p0], "masses":[2000.0], "k":[(0.000025/2000.0) * p0**4], 
...
for mdl in [2, 3]:
    for p0 in [2.0, 5.0, 7.0, 10.0, 15.0, 18.0, 20.0, 23.0, 25.0, 30.0, 35.0, 40.0]:
        #for recipe_indx in all_sets:
        #for recipe_indx in [90]:
         for recipe_indx in [ recipes.recipe_mapping([0, 1, 3, 4])  ]:
